...
let attributes = [
    {
        name: "Hydrophobic",
        desc: `This Manamal despises water and will struggle to operate in it. On Dry land, they gain a movement bonus`,
    },
    ...
    {
        name: "Burning Body",
        desc: `This Manamal exhudes a heat or cold so extreme it will burn any opponent that touches it, if they are not a fire or water type`,
    },
    ...
    {
        name: "Flexible",
        desc: `This Manamal is very pliant despite its size. It can pass through single tile spaces or diagonally between obstacles`,
    },
    { name: "Airborne", desc: `This Manamal rarely touches the ground. It will ignore terrain obstacles unless grounded` },
    {
        name: "Thin-Skinned",
        desc: `This Manamal takes increased damage from attacks, but its own attacks increase from the damage it takes`,
    },
    {
        name: "Consume",
        desc: `This Manamal has a 20% chance to swallow a smaller enemy in front of them, dealing double Bite damage per turn. It cannot move until it either kills the enemy or spits it out`,
    },
    {
        name: "Repulsive",
        desc: `This Manamal deals a small amount of damage to any nearby enemies (if they don't have Repulsive or Strong Stomach attributes)`,
    },
...
let personality = [
    ...
    { name: "Lively", bonus: ["Speed", "Bonding"], penalty: ["SPAttack", "SPDefense"] },
    {
        name: "Clingy",
        bonus: ["Bonding"],
        penalty: ["Attack", "SPAttack", "Defense", "SPDefense", "Speed", "Comfort in Crystal", "XP gain"],
    },
    { name: "Cold", bonus: ["Attack", "SPAttack", "Defense", "SPDefense", "Speed", "Comfort in Crystal", "XP gain"], penalty: ["Bonding"] },
    {
        name: "Hardy",
        bonus: ["Attack", "SPAttack", "Defense", "SPDefense", "Bonding", "Comfort in Crystal", "XP gain"],
        penalty: ["Speed"],
    },
    {
        name: "Cruel",
        bonus: ["Attack", "SPAttack", "Defense", "SPDefense", "Speed", "Comfort in Crystal", "XP gain"],
        penalty: ["Bonding"],
    },
...
// Manamals all have different strengths and weaknesses based on the class they're in
let ManamalClass = [
    {
        name: "Aquatic",
        dominates: ["Earth", "Electronic", "Fire", "Metal", "Molten", "Water"],
        weakness: ["Ceramic", "Electric", "Electronic", "Glass", "Humanoid", "Mamalian", "Plant", "Reptilan"],
    },
    {
        name: "Ceramic",
        dominates: ["Aquatic", "Earth", "Fire", "Insect", "Magic", "Water", "Wind"],
        weakness: ["Magic", "Mythic"],
    },
    {
        name: "Earth",
        dominates: ["Electric", "Electronic", "Fire", "Magic", "Wind", "Winged"],
        weakness: ["Aquatic", "Ceramic", "Molten", "Mythic", "Plant", "Psychic", "Water"],
    },
    {
        name: "Electric",
        dominates: ["Aquatic", "Humanoid", "Insect", "Mamalian", "Reptilian", "Water", "Winged"],
        weakness: ["Earth", "Electronic", "Metal", "Mythic"],
    },
    {
        name: "Fire",
        dominates: ["Humanoid", "Insect", "Mamalian", "Metal", "Mythic", "Plant", "Reptilian", "Wooden"],
        weakness: ["Aquatic", "Ceramic", "Earth", "Water", "Wind"],
    },
    {
        name: "Glass",
        dominates: ["Aquatic", "Humanoid", "Magic", "Mamalian", "Reptilian", "Water", "Wind", "Winged"],
        weakness: ["Molten", "Mythic", "Psychic"],
    },
    {
        name: "Humanoid",
        dominates: ["Aquatic", "Insect", "Paranormal", "Reptilian"],
        weakness: ["Electric", "Fire", "Glass", "Mamalian", "Metal", "Paranormal", "Reptilian", "Wind", "Wooden"],
    },
    {
        name: "Insect",
        dominates: ["Electronic", "Magic", "Plant"],
        weakness: ["Ceramic", "Electric", "Fire", "Humanoid", "Mamalian", "Paranormal", "Wind", "Winged"],
    },
    {
        name: "Magic",
        dominates: ["Ceramic", "Metal", "Plant"],
        weakness: ["Ceramic", "Earth", "Electronic", "Glass", "Insect", "Mythic", "Psychic", "Winged"],
    },
    {
        name: "Mamalian",
        dominates: ["Aquatic", "Humanoid", "Insect", "Plant", "Wind", "Wooden"],
        weakness: ["Electric", "Fire", "Glass", "Molten", "Paranormal", "Psychic", "Reptilian", "Water"],
    },
    {
        name: "Metal",
        dominates: ["Electric", "Humanoid", "Mythic", "Winged", "Wooden"],
        weakness: ["Aquatic", "Electronic", "Fire", "Magic", "Molten", "Psychic"],
    },
    {
        name: "Molten",
        dominates: ["Aquatic", "Electric", "Magic", "Metal", "Psychic"],
        weakness: ["Aquatic", "Earth", "Insect", "Molten", "Paranormal", "Water"],
    },
    {
        name: "Mythic",
        dominates: ["Ceramic", "Earth", "Electric", "Glass", "Magic", "Molten", "Water"],
        weakness: ["Fire", "Metal", "Reptilian", "Wind"],
    },
    {
        name: "Paranormal",
        dominates: ["Electronic", "Humanoid", "Insect", "Mamalian", "Psychic"],
        weakness: ["Humanoid", "Reptilian", "Wooden"],
    },
    {
        name: "Plant",
        dominates: ["Aquatic", "Earth", "Water"],
        weakness: ["Fire", "Insect", "Magic", "Mamalian", "Molten", "Wind", "Winged", "Wooden"],
    },
    {
        name: "Psychic",
        dominates: ["Earth", "Glass", "Magic", "Mamalian", "Metal", "Psychic", "Reptilian"],
        weakness: ["Electronic", "Paranormal", "Psychic"],
    },
    {
        name: "Reptilian",
        dominates: ["Aquatic", "Humanoid", "Mamalian", "Mythic", "Paranormal"],
        weakness: ["Electric", "Fire", "Glass", "Humanoid", "Psychic", "Water"],
    },
    {
        name: "Water",
        dominates: ["Earth", "Electric", "Fire", "Mamalian", "Molten", "Reptilian"],
        weakness: ["Aquatic", "Ceramic", "Electric", "Glass", "Mythic", "Plant"],
    },
    {
        name: "Wind",
        dominates: ["Fire", "Humanoid", "Insect", "Mythic", "Plant"],
        weakness: ["Ceramic", "Earth", "Glass", "Mamalian"],
    },
    {
        name: "Winged",
        dominates: ["Insect", "Magic", "Plant"],
        weakness: ["Earth", "Electric", "Glass", "Metal", "Molten", "Wooden"],
    },
    {
        name: "Wooden",
        dominates: ["Humanoid", "Paranormal", "Plant", "Winged"],
        weakenss: ["Fire", "Mamalian", "Metal"],
    },
];
